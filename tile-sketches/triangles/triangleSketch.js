...
new p5(sa => {
    ...
    sa.preload = () => {
        // load the the shader
        shader0 = sa.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
new p5(sb => {
    ...
    sb.preload = () => {
        // load the the shader
        shader1 = sb.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
new p5(sc => {
    ...
    sc.preload = () => {
        // load the the shader
        shader2 = sc.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
new p5(sd => {
    ...
    sd.preload = () => {
        // load the the shader
        shader3 = sd.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
new p5(se => {
    ...
    se.preload = () => {
        // load the the shader
        shader4 = se.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
new p5(sf => {
    ...
    sf.preload = () => {
        // load the the shader
        shader5 = sf.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
new p5(sg => {
    ...
    sg.preload = () => {
        // load the the shader
        shader6 = sg.loadShader('circles/basic.vert', 'triangles/triangle.frag');
    }
...
//     sh.preload = () => {
//         // load the the shader
//         shader7 = sh.loadShader('circles/basic.vert', 'triangles/triangle.frag');
//     }
...
new p5(wfc => {
    ...
    wfc.setup = () => {
        ...
        tiles[1] = new Tile(tileImages[1], ["BB", "BB", "AA", "AA"]);
        tiles[2] = new Tile(tileImages[2], ["BB", "AA", "BB", "AA"]);
