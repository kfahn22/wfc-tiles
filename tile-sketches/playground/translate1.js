...
new p5(wfc => {
    ...
    wfc.setup = () => {
        ...
        tiles[0] = new Tile(tileImages[0], ["AA", "AB", "AA", "AA"]);
        tiles[1] = new Tile(tileImages[1], ["AA", "AA", "DA", "BA"]);
        tiles[2] = new Tile(tileImages[2], ["AA", "BA", "AA", "AA"]);
        tiles[3] = new Tile(tileImages[3], ["AD", "AA", "AA", "AB"]);
