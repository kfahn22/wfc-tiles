...
new p5(sa => {
    ...
    sa.preload = () => {
        // load the the shader
        shader0 = sa.loadShader('train_track_generator/train.vert', 'train_track_generator/smallTrack.frag');
    }
    ...
    sa.setup = () => {
        ...
        g2Slider = sa.createSlider(0, 255, 0);
        b2Slider = sa.createSlider(0, 255, 0);
...
new p5(sb => {
    ...
    sb.preload = () => {
        // load the the shader
        shader1 = sb.loadShader('train_track_generator/train.vert', 'train_track_generator/smallTrack.frag');
    }
...
new p5(sc => {
    ...
    sc.preload = () => {
        // load the the shader
        shader2 = sc.loadShader('train_track_generator/train.vert', 'train_track_generator/smallTrack.frag');
    }
...
new p5(wfc => {
    ...
    wfc.setup = () => {
        ...
        let para0 = wfc.createP('Train Tracks');
        ...
        tiles[1] = new Tile(tileImages[1], ["B", "B", "B", "A"]);
