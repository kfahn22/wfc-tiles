// Frag shader creates train tiles for the wave function collapse algorithm.
// Basic 2d sdfs are from Inigo Quilez
...
void main()
{
  ...
  col += chooseTrack( trackChoice, uv, colA, colB, colC );
